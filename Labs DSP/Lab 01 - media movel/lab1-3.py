...
def carregar_dados():
    """
    Carrega os dados do arquivo CSV, realiza a limpeza, ordenação e cálculo
    inicial de indicadores (média móvel).
    Retorna um DataFrame do pandas pronto para as simulações.
    """
    try:
